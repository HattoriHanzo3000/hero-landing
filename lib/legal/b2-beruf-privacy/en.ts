      ...
      subsections: [
        {
          ...
          paragraphs: [
            "You have the right to obtain confirmation of whether personal data concerning you is being processed and, if so, to receive a copy of that data together with information about its processing.",
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            "You may request the deletion of your personal data, provided that no legal obligation requires its continued retention.",
          ],
        },
        {
          title: "Right to restriction of processing (Art. 18 GDPR)",
          paragraphs: [
            "You may request that the processing of your personal data be restricted in certain circumstances, for example while the accuracy of the data is being verified.",
          ],
        },
        {
          title: "Right to data portability (Art. 20 GDPR)",
          paragraphs: [
            "Where processing is based on consent or a contract and carried out by automated means, you may request that your data be provided to you or transferred to another controller in a structured, commonly used, and machine-readable format.",
          ],
        },
        {
          title: "Right to object (Art. 21 GDPR)",
          paragraphs: [
            "You have the right to object to processing carried out on the basis of legitimate interests, including profiling. Where personal data is processed for direct marketing purposes, you may object at any time.",
          ],
        },
        {
          title: "Right to withdraw consent (Art. 7(3) GDPR)",
          paragraphs: [
            "If processing is based on your consent, you may withdraw that consent at any time. Withdrawal does not affect the lawfulness of processing prior to withdrawal.",
          ],
        },
        {
          title: "Right to lodge a complaint (Art. 77 GDPR)",
          paragraphs: [
            "You may lodge a complaint with a supervisory authority, in particular in the Member State of your habitual residence, place of work, or the place of the alleged infringement. In Germany, supervisory authorities are the State Data Protection Authorities (Landesdatenschutzbehörden).",
          ],
        },
      ],
      trailingParagraphs: [
